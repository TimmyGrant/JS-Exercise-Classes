...
class Person {
  ...
  eat(someFood){
    this.stomach.length < 10 ? this.stomach.push(someFood):"no";
    } 
...
class Car {
  ...
  fill(gallons){
    this.tank += gallons;
    this.drivableMiles = Math.round(gallons * this.milesPerGallon);
  }
  drive(distance){
...
class ProjectManager extends Instructor{
  ...
  standUp(slChannel){
    return `${this.name} announces to ${slChannel}, @channel standy times!`;
  }
